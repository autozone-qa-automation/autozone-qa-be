...
public class MissingRequiredFieldException extends RuntimeException {
  ...
  /**
   * Constructs a new {@code MissingRequiredFieldException} with the specified
  ...
  /**
   * Constructs a new {@code MissingRequiredFieldException} with the default
   * message {@code "Required field is missing"}.
   */
