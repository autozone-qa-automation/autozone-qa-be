            ...
            argThat(
                release ->
                    release != null
                        ...
                        && release.getReleaseFeatureIds().equals(List.of(10L)))))
        .thenReturn(
            new ReleaseVO(
                4L,
                "Orders QA Release",
                ...
                20L,
                List.of(10L),
                List.of(new FeatureVO(10L, "Order validation", "Validates order payloads.", 20L))));
    ...
    when(releaseService.createRelease(
            argThat(
                release ->
                    release != null
                        && release.getReleaseFeatureIds() != null
                        && release.getReleaseFeatureIds().equals(List.of(999L)))))
        .thenThrow(new ResourceNotFoundException("One or more release features were not found."));
